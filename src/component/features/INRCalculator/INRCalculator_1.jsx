...
<div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
    <form class="space-y-6" >
        <div className='flex justify-between'><h5 class="text-xl font-medium text-gray-900 dark:text-blue-400">INR Calculator</h5> <h4 class="text-xl font-medium text-gray-900 dark:text-white">Target 2.0-3.0</h4></div>
        <div>
...
export default INRCalculator_1